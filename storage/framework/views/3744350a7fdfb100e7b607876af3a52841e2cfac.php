...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <?php if(!empty($course->creator) and !empty($course->creator->live_chat_js_code) and !empty(getFeaturesSettings('show_live_chat_widget'))): ?>
        <script>
            (function () {
                "use strict"

                <?php echo $course->creator->live_chat_js_code; ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel Egitim\Source\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>