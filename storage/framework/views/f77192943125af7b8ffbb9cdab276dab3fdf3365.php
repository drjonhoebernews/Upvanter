...
<?php else: ?>
    <li data-id="<?php echo e(!empty($chapterItem) ? $chapterItem->id :''); ?>" class="accordion-row bg-white rounded-sm border border-gray300 mt-20 py-15 py-lg-30 px-10 px-lg-20">
        <div class="d-flex align-items-center justify-content-between " role="tab" id="file_<?php echo e(!empty($file) ? $file->id :'record'); ?>">
            ...
            <div class="d-flex align-items-center">
                ...
                <?php if(!empty($file)): ?>
                    <a href="<?php echo e(getAdminPanelUrl()); ?>/files/<?php echo e($file->id); ?>/delete" class="delete-action btn btn-sm btn-transparent text-gray">
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH G:\Laravel Egitim\Source\resources\views/admin/webinars/create_includes/accordions/file.blade.php ENDPATH**/ ?>