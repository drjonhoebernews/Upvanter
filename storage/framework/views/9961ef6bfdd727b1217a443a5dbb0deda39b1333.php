                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e(!empty($webinar) ? $webinar->id.'/update' : 'store'); ?>" id="webinarForm" class="webinar-form">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                <label class="" for="privateSwitch"><?php echo e(trans('update.enable_waitlist')); ?></label>
                                                <div class="custom-control custom-switch">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel Egitim\Source\resources\views/admin/webinars/create.blade.php ENDPATH**/ ?>